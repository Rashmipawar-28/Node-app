...
function isMessageErrorResponseData(response) {
  return response.error !== undefined && response.message !== undefined;
}

var MessageError = /*#__PURE__*/function (_Error) {
  _inheritsLoose(MessageError, _Error);
...
var BaseMessageModule = /*#__PURE__*/function (_BaseModule) {
    ...
    try {
      var _temp3 = function _temp3(_result) {
        return _exit2 ? _result : Promise.resolve(_this2.httpClient.post(_this2.endpoint, body)).then(function (data) {
          ...
          return _this2.formatResponse(data);
        });
      };
  ...
  _proto.formatResponse = function formatResponse(response) {
    return _extends({}, response, {
